...
export default function ReaderShell({ outlineItems, outlineTitle, header, children }) {
  return (
    <div className="mx-auto grid w-full max-w-[1180px] gap-5 lg:grid-cols-[minmax(0,1fr)_auto]">
      <main className="min-w-0">
        <OutlineNav items={outlineItems} title={outlineTitle} variant="mobile" />
      ...
      <OutlineNav items={outlineItems} title={outlineTitle} variant="desktop" />
    </div>
  );
}
